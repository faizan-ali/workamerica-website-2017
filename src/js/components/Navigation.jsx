        ...
        <ul className='nav navbar-nav hidden-md-up'>
          <li className='nav-item dropdown'>
            ...
            <div className='dropdown-menu dropdown-menu-right'>
              <Link to='/'><button className='dropdown-item' type='button'>Employers</button></Link>
              <Link to='/educators'><button className='dropdown-item' type='button'>Educators</button></Link>
              <Link to='/jobseekers'><button className='dropdown-item' type='button'>Job Seekers</button></Link>
            </div>
          </li>
        </ul>
      </nav>
